...
public class DoWhileSwimming
{
    public static void main( String[] args ) throws Exception
    {
       ...
       //1. Yes, both Gallant and  Gofus swim for the same amount of time.
       //2. The swimming time changes, Gallant does not swim at all but Gofus swims for 1 minute.
       //3. Yes GAllant check the water temperature first.
       //4. No,Gofus just drives in, he does not check the water tepraturef first
      // 5. A do while loop executes a statement at least once before testing the conditon but a while loop test the condition first before executing the statement.
